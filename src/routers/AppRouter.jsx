...
// Revert back to history v4.10.0 because v5.0 breaks navigation
export const history = createBrowserHistory();

const AppRouter = () => {
  const location = useLocation();  // ✅ Now inside the function component
  const isPublic = ['/contact'].some(route => location.pathname.startsWith(route));
  return (
    <>
      {!isPublic && <Navigation />}  {/* Conditionally render navigation */}
      <Basket />
      <Switch>
        ...
        <PublicRoute component={view.ContactPage} path={ROUTES.CONTACT} />
